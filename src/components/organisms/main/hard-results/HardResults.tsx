    ...
    <div>
      <Container>
        ...
        <Row className="mt-5 pt-5 mb-5 pb-5">
          ...
          <Col sm={5}>
            <h4 className="text-end">
              ...
              by podwoić ilość <br /> zamówień bez <br /> zwiększania <br /> budżetu na <br /> reklamy.
            </h4>
          </Col>
        </Row>
        ...
        <p>
          ...
          chodzi tu o poprawę prędkości ładowania strony internetowej. Chodzi o
          rzetelne testowanie każdej obiecującej hipotezy testem A/B.
        </p>
        <p>
          W Owocnych uważnie projektujemy świat, do którego zapraszasz swoich
          nowych klientów. Pomyśl przez chwilę.
        </p>
        <p>
          Biznes prowadzi się prościej, gdy klient ufa firmie od pierwszego
          spojrzenia. Dojrzała marka łatwo wybija się przed całą „szablonową“
          konkurencję.
        </p>
        <ReactPlayer
        ...
        />
          ...
          <p>
            Świetne marki od zawsze przyciągają najlepszych pracowników, uwodzą
            klientów i napędzają zyski.
          </p>
          <ReactPlayer
          ...
          <p>
            Budujemy marketing klientów w Polsce, Niemczech, Włoszech, Anglii i
            Hiszpanii pod marką Hello Juicy.
          </p>
          <ReactPlayer
          ...
          <p>
            ...
            cytowani są przez największe media w branży. Min. magazyn Forbes czy
          ...
          <h4 className={style.hardBottomContent}>Owocni eksperci cytowani są przez:</h4>
