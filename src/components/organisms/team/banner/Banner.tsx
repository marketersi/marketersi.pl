        ...
        <div className={style.bannerBottomContent}>
          <Row>
            <Col sm={6}>
              ...
              <h2>Pomagamy <br /> dobrym ludziom <br /><span> robićdobry biznes</span></h2>
            </Col>
            <Col sm={6}>
                <img src="https://owocni.pl/_next/image?url=%2F_next%2Fstatic%2Fmedia%2Flampa.75f3a55b.png&w=750&q=75" alt="" />
            </Col>
          </Row>
