...
const ContactCard = ({ title, name, phone, email, image, id }) => {
  return (
    <div className="card">
      ...
      {/* Optional flag image — keep if needed */}
      <img className="CountryFlag" src="https://www.owocni.pl/_next/image?url=%2F_next%2Fstatic%2Fmedia%2FEnglish.d32cd609.png&w=256&q=100" alt="English Available" />
