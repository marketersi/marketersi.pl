...
<section className="thematic-section-orange" id='sec2'>
        ...
        <div className="copywriter-text-center">
          <img
            src="https://cdn.owocni.pl/img/single-copywriter/seo-images/hurom.jpg"
          ...
          <div className="row">
            <div className="col-md-12 text-center">
              ...
              <div className="names-client-desc copywriter-client-desc-margin copywriter-custom-mright-3 copywriter-white-text">
                Treści strony produktowej „landing page”, <br /> której celem
                jest sprzedaż najnowszej <br />
                wyciskarki Hurom
              </div>
            </div>
            ...
            <div className="col-md-12">
              <p className="theme-desc copywriter-custom-mright copywriter-orange-black-text">
                Hurom robi perfekcyjne wyciskarki wolnoobrotowe. Nic dziwnego.{" "}
                <br />
                To on je wymyślił. My wymyśliliśmy gwiazdorski sposób na polską{" "}
                <br />
                premierę. Strona docelowa prezentuje wszystkie wyróżniające
                cechy <br />
                modelu Hurom H100 w najsmaczniejszy możliwy sposób. Oto
                fragment.
              </p>
            </div>
          </div>
        ...
        <div className="copywriter-text-center copywriter-standard-mtb-40 copywriter-rwd-mtb-40">
          <img
            src="https://cdn.owocni.pl/img/single-copywriter/seo-images/Teksty-do-strony-hurum.jpg"
        ...
        <div className="copywriter-text-center copywriter-standard-mt-40 copywriter-rwd-mtb-40">
          <img
            src="https://cdn.owocni.pl/img/single-copywriter/seo-images/Hasla-reklamowe-hurum.jpg"
        ...
        <div className="copywriter-text-center">
          <img
            ...
            src="https://cdn.owocni.pl/img/single-copywriter/seo-images/Slogan-reklamowy-hurum.jpg"
