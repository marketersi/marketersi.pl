...
//           </div>
//           <p>
//             Świetnie – Twoją stronę już sprawdzamy.<br />
//             A co z reklamami, komunikacją i działaniami,<br />
//             które mają tam prowadzić?<br />
...
const Question14 = () => {
  ...
  const osClass = useOsClass();
  const getBottomParagraph = () => {
    if (formZeroType === "marketing") {
      return `Świetnie – Twój marketing już sprawdzamy.<br />
        A co z reklamami, komunikacją i działaniami,<br />
        które mają tam prowadzić?<br />
        Zamów bezpłatne badanie marketingu – to nic nie kosztuje,<br />
        a może zmienić wiele.`;
    } else {
      return `Świetnie – Twoją stronę już sprawdzamy.<br />
        A co z reklamami, komunikacją i działaniami,<br />
        które mają tam prowadzić?<br />
        Zamów bezpłatne badanie strony – to nic nie kosztuje,<br />
        a może zmienić wiele.`;
    }
  };

  const getButtonText = () => {
    return formZeroType === "marketing"
      ? "Zamów bezpłatne badanie marketingu"
      : "Zamów bezpłatne badanie strony";
  };
  return (
    <>
      {showGif && (
      ...
      <div className="question_14">
        <h2>Gotowe!</h2>
        <p>
          Teraz czas na ruch po naszej stronie.<br/>
          Sprawdzimy Twoją sytuację<br/>
          i wrócimy z konkretem.<br/>
        </p>
        <div className='AuccessWarningbox'>
        ...
        <div className='BottomSuccessBox'>
          ...
          <p dangerouslySetInnerHTML={{ __html: getBottomParagraph() }} />
           <div className="buttonWrapper">
            <motion.a
              href="https://marketersi.pl/zamow-bezplatne-badanie"
              className="FinalBTN bigBtn"
