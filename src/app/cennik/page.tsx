...
const PriceListScreen = () => {
  ...
  const handleBtnClick = (value) => {
    ...
    newSearchParams.set("card", value.toString());
    router.push(`?${newSearchParams.toString()}`, undefined, { shallow: true });
  };

  // Get the selected card from the URL on load
  const selectedOption = searchParams.get("card") ? parseInt(searchParams.get("card"), 10) : null;
  ...
  // Set isRed based on selectedOption from URL
  useEffect(() => {
    if (selectedOption !== null) {
      setIsRed(selectedOption);
    }
  }, [selectedOption]);
    ...
    <>
      {isLoading ? (
        ...
        <section className="container pb-5">
          <div className="row justify-content-center">
            <div className="col-xl-8 text-center">
              <h2 className="mt-5 heading-style">
                Odblokuj Zyski z Marketersi:<br />
                Pierwszy Krok<br />
                ku Wielkim Zmianom
              </h2>
              <div className="mt-3">
